Perfect 👍 — here is your **complete, clean, production-ready multi-environment setup** using:
...
* ✅ GCS buckets (with lifecycle)
* ✅ IAM (service accounts + configurable roles)
* ✅ Environment-aware naming
* ✅ Fully configurable variables
* ✅ Safe for dev/staging/prod

---

# 📄 main.tf  (FULL FINAL VERSION)
...
dataset_id       = "training_dataset_staging"
table_id         = "features_table"
dataset_location = "asia-south1"
...
You now have a clean, multi-environment, professional Terraform setup.

If you want next step: I can now show you how to properly separate state per environment (very important for real production).
